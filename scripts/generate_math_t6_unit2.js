...
const OUT = 'Manuel_Mathematiques_T6_V2_UNITE2.docx';
...
// Une représentation visuelle ouvre chaque page LEÇON.
const unit2Visuals=[grid100,grid100,grid100,grid100,numberLine,grid100,numberLine,grid100,numberLine,numberLine,fractionBars,fractionBars,numberLine];
sessions.forEach((s,i)=>{s.img=unit2Visuals[i];});

sessions[4].scene=fs.readFileSync('assets/math-t6/scenes/scene_echelle_carte.png');
sessions[5].scene=fs.readFileSync('assets/math-t6/scenes/scene_pourcentage_classe.png');

[8,9,10,11,12].forEach(i=>sessions[i].scene=fs.readFileSync('assets/math-t6/scenes/scene_calcul_mental_marche.png'));

[0,1,2,3].forEach(i=>sessions[i].scene=fs.readFileSync('assets/math-t6/scenes/scene_priorites_operations.png'));

[6,7].forEach(i=>sessions[i].scene=fs.readFileSync('assets/math-t6/scenes/scene_pourcentage_classe.png'));
