...
MAPPING = {
    ...
    31: ("img_seance31.png", "Les trois grandes catégories de substances psychoactives : l'alcool, le tabac et certains médicaments détournés de leur usage."),
    ...
    36: ("img_seance36.png", "La consultation permet d'exposer ses symptômes en confiance : la parole est le premier pas vers les soins."),
    37: ("img_seance37.png", "Trois leviers de prévention : la scolarisation qui retarde la première grossesse, le suivi prénatal, et une alimentation riche en protéines et en fer."),
    38: ("cycle_menstruel_schema.png", "Le cycle menstruel de 28 jours : règles, phase folliculaire, ovulation et phase lutéale, avec l'évolution de la muqueuse utérine."),
    39: ("img_seance39.png", "L'utérus : le corps en haut, le col en bas (teinte plus soutenue). L'agrandissement montre la zone de jonction du col, où naît la plupart des cancers."),
    40: ("img_seance40.png", "Dépistage et vaccination : deux protections complémentaires."),
    41: ("img_seance41.png", "Concevoir en groupe une affiche de sensibilisation destinée aux autres élèves de l'école."),
    ...
    46: ("img_seance46.png", "Les principaux gisements de pierres gemmes à Madagascar : saphir dans le Sud (bleu), rubis dans l'Est et le Centre-Est (rouge), tourmaline et béryl dans le Centre (vert), émeraude sur la côte Est (violet), labradorite au Nord-Ouest (orange)."),
