...
const sessions = [
 {t:"Formuler une question ou une hypothèse",goal:"formuler une question adaptée à une expérience",concept:"Une question statistique admet plusieurs réponses et nécessite des données. Une hypothèse est une réponse provisoire que l’expérience permettra de vérifier.",example:"Question : « Quel moyen de transport les élèves utilisent-ils ? » Hypothèse : « La marche est le moyen le plus fréquent. »",app:["Distingue question statistique et question à réponse unique : âge des élèves ; résultat de 8 × 7 ; temps de trajet ; couleur préférée.", "Explique les quatre réponses et indique le tableau, diagramme ou calcul utilisé."],ans:["Statistiques : âge, temps de trajet, couleur préférée. Réponse unique : 8 × 7.", "Chaque justification doit citer les données pertinentes et conduire clairement à la conclusion."]},
 {t:"Préparer un sondage quantitatif",goal:"rédiger des questions claires et mesurables",concept:"Une question quantitative produit une réponse numérique. Elle doit préciser la population, l’unité et la période si nécessaire, sans orienter la réponse.",example:"« Combien de minutes mets-tu pour venir à l’école ? » produit une durée mesurable.",app:["Améliore : Fais-tu beaucoup de sport ? Lis-tu souvent ? Ta famille est-elle grande ? Bois-tu assez d’eau ?", "Explique les quatre réponses et indique le tableau, diagramme ou calcul utilisé."],ans:["Exemples : combien de minutes de sport par semaine ? combien de livres par mois ? combien de personnes dans ta famille ? combien de verres d’eau par jour ?", "Chaque justification doit citer les données pertinentes et conduire clairement à la conclusion."]},
 {t:"Choisir une stratégie de collecte",goal:"choisir entre questionnaire, observation, entretien et données secondaires",concept:"Le choix dépend de la question, du temps et des personnes interrogées. Le questionnaire recueille beaucoup de réponses ; l’observation compte des faits ; l’entretien approfondit ; les données secondaires existent déjà.",example:"Pour compter les véhicules devant l’école, l’observation directe est adaptée.",app:["Choisis : opinions de 200 élèves ; nombre d’oiseaux dans une cour ; raisons d’une absence ; population d’une commune déjà recensée.", "Explique les quatre réponses et indique le tableau, diagramme ou calcul utilisé."],ans:["Questionnaire ; observation ; entretien ; données secondaires.", "Chaque justification doit citer les données pertinentes et conduire clairement à la conclusion."]},
 {t:"Organiser les données dans un tableau",goal:"construire un tableau d’effectifs",concept:"Un tableau indique le titre, les catégories, les effectifs et le total. Les marques de comptage facilitent l’enregistrement avant le calcul des effectifs.",example:"Effectifs 8, 12, 5 et 15 : l’effectif total est 40.",app:["Calcule les totaux : 6, 9, 10, 5 ; 12, 8, 7, 13 ; 25, 15, 20, 10 ; 4, 11, 9, 6.", "Explique les quatre réponses et indique le tableau, diagramme ou calcul utilisé."],ans:["30 ; 40 ; 70 ; 30.", "Chaque justification doit citer les données pertinentes et conduire clairement à la conclusion."]},
 {t:"Construire pictogramme et diagramme à bandes",goal:"représenter des effectifs avec une échelle",concept:"Un pictogramme utilise des symboles avec une légende. Un diagramme à bandes utilise des rectangles de même largeur ; leur hauteur suit une échelle régulière.",example:"Si une image représente 5 élèves, 4 images représentent 20 élèves.",app:["Avec 1 symbole pour 4 objets, donne les effectifs de 2, 5, 7 et 10 symboles. Puis donne le nombre de symboles pour 12, 24, 32 et 40 objets.", "Explique les quatre réponses et indique le tableau, diagramme ou calcul utilisé."],ans:["8, 20, 28, 40 objets ; 3, 6, 8, 10 symboles.", "Chaque justification doit citer les données pertinentes et conduire clairement à la conclusion."]},
 {t:"Construire un diagramme à ligne brisée",goal:"représenter une évolution dans le temps",concept:"Un diagramme à ligne brisée place les valeurs dans l’ordre du temps puis relie les points. Le titre, les axes, les unités et l’échelle sont indispensables.",example:"Les températures 18, 20, 23 et 21 °C donnent une hausse puis une baisse.",app:["Décris l’évolution : 10, 14, 18, 16 ; 30, 25, 20, 15 ; 5, 5, 8, 8 ; 12, 17, 15, 20.", "Explique les quatre réponses et indique le tableau, diagramme ou calcul utilisé."],ans:["Hausse puis baisse ; baisse continue ; stabilité, hausse, stabilité ; hausse, baisse, hausse.", "Chaque justification doit citer les données pertinentes et conduire clairement à la conclusion."]},
 {t:"Lire un diagramme à tige et à feuilles",goal:"organiser une série en conservant chaque valeur",concept:"Dans un diagramme à tige et à feuilles, la tige porte les dizaines et la feuille les unités. Une clé explique la lecture, par exemple 2 | 7 signifie 27.",example:"Pour 21, 24, 24, 28 : tige 2 et feuilles 1, 4, 4, 8.",app:["Écris tiges et feuilles pour 12, 15, 18, 21 ; puis 23, 27, 31, 35 ; puis 40, 42, 46, 49 ; puis 54, 55, 55, 58.", "Explique les quatre réponses et indique le tableau, diagramme ou calcul utilisé."],ans:["1 | 2 5 8 et 2 | 1 ; 2 | 3 7 et 3 | 1 5 ; 4 | 0 2 6 9 ; 5 | 4 5 5 8.", "Chaque justification doit citer les données pertinentes et conduire clairement à la conclusion."]},
 {t:"Interpréter moyenne, médiane et mode",goal:"calculer et choisir un indicateur central",concept:"La moyenne est la somme divisée par l’effectif. La médiane partage la série ordonnée en deux groupes. Le mode est la valeur la plus fréquente.",example:"Pour 2, 3, 3, 4, 8 : moyenne 4, médiane 3 et mode 3.",app:["Calcule moyenne, médiane et mode : 2, 4, 4, 6 ; 5, 5, 7, 7, 7, 11 ; 3, 6, 6, 9 ; 10, 12, 12, 14.", "Explique les quatre réponses et indique le tableau, diagramme ou calcul utilisé."],ans:["4, 4, 4 ; 7, 7, 7 ; 6, 6, 6 ; 12, 12, 12.", "Chaque justification doit citer les données pertinentes et conduire clairement à la conclusion."]},
 {t:"Comparer probabilité théorique et expérimentale",goal:"distinguer prévision et fréquence observée",concept:"La probabilité théorique repose sur les résultats possibles supposés équiprobables. La probabilité expérimentale est le rapport entre succès observés et nombre d’essais ; elle se rapproche souvent de la théorie quand les essais augmentent.",example:"Pour une pièce équilibrée, P(pile) = 1/2. Si pile sort 47 fois en 100 essais, la fréquence est 47/100 = 47 %.",app:["Donne la probabilité : obtenir pile ; obtenir 6 avec un dé ; obtenir un nombre pair avec un dé ; tirer une boule rouge parmi 3 rouges et 2 bleues.", "Explique les quatre réponses et indique le tableau, diagramme ou calcul utilisé."],ans:["1/2 ; 1/6 ; 3/6 = 1/2 ; 3/5.", "Chaque justification doit citer les données pertinentes et conduire clairement à la conclusion."]},
 {t:"Utiliser arbre et tableau de probabilités",goal:"énumérer tous les résultats possibles",concept:"Un diagramme en arbre montre les choix successifs. Chaque chemin représente un résultat. Un tableau peut également croiser les résultats de deux expériences.",example:"Deux lancers de pièce donnent PP, PF, FP et FF : quatre résultats équiprobables.",app:["Deux pièces : probabilité de deux piles, d’une pile exactement, d’au moins une pile, d’aucune pile.", "Explique les quatre réponses et indique le tableau, diagramme ou calcul utilisé."],ans:["1/4 ; 2/4 = 1/2 ; 3/4 ; 1/4.", "Chaque justification doit citer les données pertinentes et conduire clairement à la conclusion."]},
 {t:"Exprimer et comparer des probabilités",goal:"passer entre fraction, décimal et pourcentage",concept:"Une probabilité est comprise entre 0 et 1, soit entre 0 % et 100 %. 0 signifie impossible, 1 certain. On peut l’écrire en fraction, nombre décimal ou pourcentage.",example:"3/4 = 0,75 = 75 % est plus probable que 1/2 = 0,5 = 50 %.",app:["Convertis et classe : 1/4 ; 0,6 ; 80 % ; 1/2.", "Explique les quatre réponses et indique le tableau, diagramme ou calcul utilisé."],ans:["1/4 = 0,25 = 25 % ; 1/2 = 0,5 = 50 % ; 0,6 = 60 % ; 80 % = 0,8. Ordre croissant : 1/4, 1/2, 0,6, 80 %.", "Chaque justification doit citer les données pertinentes et conduire clairement à la conclusion."]}
];
...
function exam(){return [page(),title('SÉANCE 13 / 13 — SUJET D’EXAMEN T6 — UNITÉ VI',1,'u6_l13'),p('Barème : 20 points.'),p('Exercice 1 — 4 points. Pour étudier le trajet vers l’école, formule une question statistique, une hypothèse, une question quantitative et choisis une méthode de collecte.'),p('Exercice 2 — 4 points. Les effectifs des moyens de transport sont 18, 12, 7 et 3. Calcule le total et les pourcentages correspondants.'),p('Exercice 3 — 4 points. Pour la série 4, 6, 6, 8, 11, calcule moyenne, médiane, mode et étendue.'),p('Exercice 4 — 4 points. Deux pièces sont lancées. Construis la liste des résultats et calcule les probabilités d’obtenir deux piles, exactement une pile et au moins une pile.'),p('Exercice 5 — 4 points. Classe du moins probable au plus probable : 1/5, 0,45, 70 %, 3/4. Exprime chaque valeur en pourcentage.'),title('CORRIGÉ ET BARÈME',2),correction('Exercice 1. ','Exemple valide : « Quel moyen de transport utilises-tu ? » ; hypothèse : « la marche domine » ; durée du trajet en minutes ; questionnaire. Un point par élément.'),correction('Exercice 2. ','Total 40. Pourcentages : 45 %, 30 %, 17,5 % et 7,5 %. Un point pour le total et trois points pour les taux.'),correction('Exercice 3. ','Moyenne 7 ; médiane 6 ; mode 6 ; étendue 7. Un point par indicateur.'),correction('Exercice 4. ','PP, PF, FP, FF. P(deux piles) = 1/4 ; P(exactement une pile) = 1/2 ; P(au moins une pile) = 3/4.'),correction('Exercice 5. ','1/5 = 20 % < 0,45 = 45 % < 70 % < 3/4 = 75 %. Un point par conversion et classement cohérent.')];}
