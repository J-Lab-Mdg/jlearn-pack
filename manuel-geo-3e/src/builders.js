// Builders docx — Manuel Géographie 3e J-Learn (Traitement C)
const fs = require("fs");
const {
...
module.exports = { miniTable, C, FONT, runs, p, empty, pageBreak, titled, tocLink, metaTable, deroulementTable, sectionRow, stepRow, exoEnonceLines, exoCorrigeLines, exercicesSection, leconTitre, leconSousTitre, leconSousSous, leconPara, leconPuce, dataTable, figure, cell, noBorders, thinBorders, AlignmentType };
