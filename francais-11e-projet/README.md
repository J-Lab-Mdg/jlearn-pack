...
| 2 | Les sons I et U (Phonétique) | 11-20 | ⏳ Prochain relais |
| 3+ | Se présenter, son OUI, son U, le village, son GN + extension FRA (T2, T3) | 21-… | ⏳ |
...
node src/assemble-bloc1.js        # → output/Manuel_Francais_11e_V1_BLOC1.docx
python3 verify_docx.py output/Manuel_Francais_11e_V1_BLOC1.docx   # 22 vérifications skill v18
```
