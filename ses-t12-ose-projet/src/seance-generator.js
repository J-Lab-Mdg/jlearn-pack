// ============================================================
// seance-generator.js — génère le contenu d'une séance (SES T12, série OSE)
...
function buildExosSection(appExos, evalExos, anchor) {
...
function generateSeanceDocContent(topic, seanceNum, totalSeances) {
  ...
  const meta = {
    ...
    documentation: "Programme d'Études — Classe de T12, série OSE (Sciences économiques et sociales)",
    support: topic.supportMeta || "",
    date: "____________",
    classe: "T12 — Série OSE",
  ...
  const exos = buildExosSection(appExos, evalExos, null);
