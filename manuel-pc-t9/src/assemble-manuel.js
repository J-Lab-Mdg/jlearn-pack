// assemble-manuel.js — assemble le manuel complet Physique-Chimie T9 J-Learn
...
const plan = [
  {
    ...
    titre: "UNITÉ I — La mécanique",
    surtitre: "UNITÉ I", sousTitre: "LA MÉCANIQUE",
  ...
  },
  {
    ...
    titre: "UNITÉ III — L'optique",
    surtitre: "UNITÉ III", sousTitre: "L'OPTIQUE",
  ...
  },
  {
    ...
    titre: "UNITÉ IV — La chimie",
    surtitre: "UNITÉ IV", sousTitre: "LA CHIMIE",
...
const annexesToc = [
  ...
  { titre: "Annexe 2 — Tableau périodique simplifié et échelle de pH", anchor: "annexe2" },
...
children.push(B.p("Formules • Tableau périodique et pH • Conversions • Glossaire • Sécurité • Auto-évaluation • Index • Bibliographie", {
...
B.Packer.toBuffer(doc).then(buf => {
  ...
  const out = path.join(outDir, "Manuel_Physique-Chimie_T9_JLearn_V1.docx");
