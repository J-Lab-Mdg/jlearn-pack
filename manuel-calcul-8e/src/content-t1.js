...
M.multiplication = {
  ...
  lecon: [
    ...
    methode("Méthode — La preuve par 9 de la multiplication", [
      "Je trace une croix. Je calcule la **somme des chiffres du premier facteur** et je la réduis à un seul chiffre (**si je trouve 9, j'écris 0**) : je l'écris à **gauche**.",
      "Même chose pour le deuxième facteur : à **droite**.",
      "Je multiplie gauche × droite, je réduis à un chiffre : j'écris en **haut**.",
      "Je réduis la somme des chiffres du **produit** : j'écris en **bas**.",
      "Si **haut = bas**, la multiplication est probablement juste. Si haut ≠ bas, elle est sûrement fausse.",
    ]),
...
M.division = {
  ...
  lecon: [
    ...
    methode("Méthode 2 — La preuve par 9 de la division", [
      "À **gauche** de la croix : la somme réduite des chiffres du **diviseur** ; à **droite** : celle du **quotient**.",
      "En **haut** : gauche × droite, **plus le reste réduit**, le tout réduit à un chiffre.",
      "En **bas** : la somme réduite des chiffres du **dividende**. Si haut = bas, la division est juste.",
    ]),
