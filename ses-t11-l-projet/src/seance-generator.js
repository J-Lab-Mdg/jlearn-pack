// ============================================================
// seance-generator.js — génère le contenu d'une séance (SES T11, série L)
...
function generateSeanceDocContent(topic, seanceNum, totalSeances) {
  ...
  const meta = {
    ...
    documentation: "Programme d'Études — Classe de T11, série L (Sciences économiques et sociales)",
