// ============================================================
// generate.js — génération du fichier .docx (Manuel SES T11, série L)
// Manuel complet : 5 unités, 35 séances (70 heures du Programme d'Études)
// ============================================================
const fs = require("fs");
...
const OUT_FILE = process.env.OUT_FILE
  || path.join(OUT_DIR, "Manuel_SES_T11_L_JLearn.docx");
