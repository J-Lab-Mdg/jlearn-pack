...
function buildCouverture(rootDir) {
  ...
  out.push(B.p("Classe de T8", { bold: true, size: 30, align: AlignmentType.CENTER, spacingAfter: 300 }));
...
function buildAvantPropos() {
  ...
  [
    "Ce manuel de Sciences Physiques pour la classe de T8 a été conçu conformément au programme d'études officiel du Ministère de l'Éducation Nationale de Madagascar. Il couvre l'intégralité du programme de l'année en trente-trois séances, complétées par un examen blanc de fin d'année.",
    ...
    "Nous souhaitons que ce manuel soit un compagnon fidèle de l'enseignant comme de l'apprenant, et qu'il contribue à faire aimer les sciences physiques à tous les élèves de T8.",
