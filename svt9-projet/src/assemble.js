// ============================================================
// assemble.js — assemblage final du manuel SVT T9 (3e)
// ============================================================
const fs = require("fs");
...
function coverPage() {
  return [
    ...
    B.p("CLASSE DE T9 (3e)", { bold: true, size: 30, align: AlignmentType.CENTER, spacingAfter: 200 }),
...
function avantPropos() {
  ...
  out.push(B.p("Les séances sont regroupées en cinq unités, une par thématique du programme. Chaque unité se termine par une séance de révision et un « Sujet d'examen 3e » corrigé, avec barème.", { size: 21, spacingAfter: 120 }));
...
function tableauDeBord(u, startNum) {
  ...
  out.push(B.p("Résultat d'apprentissage spécifique (PE T9) : " + u.ras, { size: 20, spacingAfter: 60 }));
